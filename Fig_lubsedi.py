...
def getData(filename):
    ...
    v0 = np.loadtxt("new"+v0file, delimiter=",", usecols=[1, 8, 13])
    v1 = np.loadtxt("new"+v1file, delimiter=",", usecols=[1, 8, 13])
...
v0p6, v1p6 = getData("lubsedip6.txt")
v0p8, v1p8 = getData("lubsedip8.txt")
v0p10, v1p10 = getData("lubsedip10.txt")
v0p12, v1p12 = getData("lubsedip12.txt")
v0p16, v1p16 = getData("lubsedip16.txt")
v0p24, v1p24 = getData("lubsedip24.txt")
...
Lv0p6, = ax1.plot(v0p6[:, 0], np.abs(v0p6[:, 1]-v0true[:, 1])*transfactor, '-',
                  markeredgecolor='#FF0000', markerfacecolor='none', color='#FF0000')
Lv0p8, = ax1.plot(v0p8[:, 0], np.abs(v0p8[:, 1]-v0true[:, 1])*transfactor, '-',
                  markeredgecolor='#00DD00', markerfacecolor='none', color='#00DD00')
Lv0p10, = ax1.plot(v0p10[:, 0], np.abs(v0p10[:, 1]-v0true[:, 1])*transfactor, '-',
                   markeredgecolor='#0000FF', markerfacecolor='none', color='#0000FF')
Lv0p12, = ax1.plot(v0p12[:, 0], np.abs(v0p12[:, 1]-v0true[:, 1])*transfactor, '-',
                   markeredgecolor='#00DDDD', markerfacecolor='none', color='#00DDDD')
Lv0p16, = ax1.plot(v0p16[:, 0], np.abs(v0p16[:, 1]-v0true[:, 1])*transfactor, '-',
                   markeredgecolor='#FF00DD', markerfacecolor='none', color='#FF00DD')
Lv0p24, = ax1.plot(v0p24[:, 0], np.abs(v0p24[:, 1]-v0true[:, 1])*transfactor, '-',
                   markeredgecolor='#000000', markerfacecolor='none', color='#000000')


ax1.set_ylim(1e-14, 1e-2)
ax1.set_yscale('log')
ax1.set_ylabel(r'$\lvert u_{z,error} \rvert/(F_G/6\pi\eta a)$')
...
Lve01p6, = ax2.plot(v0p6[:, 0], np.abs(v0p6[:, 1]-v1p6[:, 1])*transfactor, '--',
                    markeredgecolor='#FF0000', markerfacecolor='none', color='#FF0000')
Lve01p8, = ax2.plot(v0p8[:, 0], np.abs(v0p8[:, 1]-v1p8[:, 1])*transfactor, '--',
                    markeredgecolor='#00DD00', markerfacecolor='none', color='#00DD00')
Lve01p10, = ax2.plot(v0p10[:, 0], np.abs(v0p10[:, 1]-v1p10[:, 1])*transfactor, '--',
                     markeredgecolor='#0000FF', markerfacecolor='none', color='#0000FF')
Lve01p12, = ax2.plot(v0p12[:, 0], np.abs(v0p12[:, 1]-v1p12[:, 1])*transfactor, '--',
                     markeredgecolor='#00DDDD', markerfacecolor='none', color='#00DDDD')
Lve01p16, = ax2.plot(v0p16[:, 0], np.abs(v0p16[:, 1]-v1p16[:, 1])*transfactor, '--',
                     markeredgecolor='#FF00DD', markerfacecolor='none', color='#FF00DD')
Lve01p24, = ax2.plot(v0p24[:, 0], np.abs(v0p24[:, 1]-v1p24[:, 1])*transfactor, '--',
                     markeredgecolor='#000000', markerfacecolor='none', color='#000000')

ax2.set_ylim(1e-14, 1e-2)
ax2.set_yscale('log')
ax2.set_ylabel(r'$\lvert \Delta u_z \rvert/(F_G/6\pi\eta a)$')
...
# export
plt.savefig('Fig_Lubsedi.png', bbox_inches=0, dpi=300)
# plt.show()
