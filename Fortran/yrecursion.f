...
c
c
      subroutine ylgndru2sfe(nmax, x, y, d, rat1, rat2, id)
      implicit none
c
c     Evaluate scaled normalized Legendre functions and their derivatives
c
...
c
      integer nmax, m, n, id(0:nmax,0:nmax)
      real *8 x, y(0:nmax,0:nmax), d(0:nmax,0:nmax), u, du, sc
      real *8 rat1(0:nmax,0:nmax), rat2(0:nmax,0:nmax)
c
...
c
      integer nmax, m, n, id(0:nmax,0:nmax)
      real *8 x, y(0:nmax,0:nmax), d(0:nmax,0:nmax), u, u2, sc
      real *8 rat1(0:nmax,0:nmax), rat2(0:nmax,0:nmax)
...
c
c
      subroutine ylgndru2sfex(nmax, x, y, d, rat1, rat2, id)
      implicit none
c
c     Evaluate scaled normalized Legendre functions and their derivatives
c
...
c
      ...
      call ylgndru2sfe(nmax, x, y, d, rat1, rat2, id)
