...
c
        ...
        do m=0,n
        u2(1,n,m)=u2(1,n,m)*scale
        u2(2,n,m)=u2(2,n,m)*scale
        enddo
        enddo
c
        scale=sqrt(1-x*x)
...
c
        ...
        data ima/(0.0d0,1.0d0)/
c
        call ulgndr(nmax,x,y,d,x2)
        call sphrot90i((nmax+1)**2,x2)
c
        return
        end
c
...
c
        ...
        data ima/(0.0d0,1.0d0)/
c
        call ulgndr(nmax,x,y,d,u2)
        call sphrot90u((nmax+1)**2,u2,x2)
c
        return
        end
c
...
c
        ...
        data ima/(0.0d0,1.0d0)/
c
        call ulgndr_trunc(nmax,m2,x,y,d,x2)
        call sphrot90i((nmax+1)**2,x2)
c
        return
        end
...
c
        ...
        data ima/(0.0d0,1.0d0)/
c
        call ulgndr_trunc(nmax,m2,x,y,d,u2)
        call sphrot90u((nmax+1)**2,x2,x2)
c
        return
        end
c
