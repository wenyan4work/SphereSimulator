...
# SOURCE FILE LIST
#
vpath %.f .:..:../lib:../../H3DLibraries:../../L3DLibraries

FMODS = 

FSRCS = sphtrans_dr.f prinm.f sphtrans.f \
    rotproj_cmpl.f rotviajrec.f rotviarecur3.f \
    yrecursion.f legeexps.f chebexps.f dfft.f fftnext.f prini.f \
    hkrand.f dlaran.f
